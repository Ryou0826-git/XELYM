...
//class DCD_R;
//
//    void allocateMemory(float**& x, float**& y, float**& z, int nAtoms, int nFrames);
//    void readAndStoreCoordinates(DCD_R& dcdf, float** x, float** y, float** z, int nAtoms, int nFrames);
//    void deallocateMemory(float** x, float** y, float** z, int nAtoms);
